...
call :buildPatchSection src\2BL\2620 sb_vfuses_rgh13_01w
...
echo.
echo 17489 RGLoader RGH 1.3...

mkdir output\17489_RGLoader_RGH1.3

REM *** For RGLoader, the patch sets for 16mb machines are all identical as they use the same loaders and kernel
copy /b src\2BL\2620\sb_vfuses_rgh13_01w.bin + src\4BL\17489\sd_vfuses_sb.bin + src\KHV\17489_RGLoader\khv_vfuses_sb.bin output\17489_RGLoader_RGH1.3\patches_g2mjasper.bin
copy output\17489_RGLoader_RGH1.3\patches_g2mjasper.bin output\17489_RGLoader_RGH1.3\patches_g2mxenon.bin
copy output\17489_RGLoader_RGH1.3\patches_g2mjasper.bin output\17489_RGLoader_RGH1.3\patches_g2mxenon_ELPIS.bin
copy output\17489_RGLoader_RGH1.3\patches_g2mjasper.bin output\17489_RGLoader_RGH1.3\patches_g2mzephyr.bin
...
echo 17489 XDKBuild RGH 1.3...

mkdir output\17489_XDKBuild_RGH1.3

REM *** For XDKBuild, the patch sets for 16mb machines are all identical as they use the same loaders and kernel
copy /b src\2BL\2620\sb_vfuses_rgh13_01w.bin + src\4BL\17489\sd_vfuses_sb.bin + src\KHV\17489_XDKBuild\khv_vfuses_sb.bin output\17489_XDKBuild_RGH1.3\patches_g2mjasper.bin
copy output\17489_XDKBuild_RGH1.3\patches_g2mjasper.bin output\17489_XDKBuild_RGH1.3\patches_g2mxenon.bin
copy output\17489_XDKBuild_RGH1.3\patches_g2mjasper.bin output\17489_XDKBuild_RGH1.3\patches_g2mxenon_ELPIS.bin
copy output\17489_XDKBuild_RGH1.3\patches_g2mjasper.bin output\17489_XDKBuild_RGH1.3\patches_g2mzephyr.bin
